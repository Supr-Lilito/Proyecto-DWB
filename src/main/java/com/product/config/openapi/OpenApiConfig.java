...
public class OpenApiConfig {
	...
	public OpenAPI customOpenAPI() {
		return new OpenAPI().info(new Info().title("DWB - API Product").version("0.0.1")
				.description("API para la gestión de productos para la tienda en línea Albañiles Store."));
	}
